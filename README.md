# 📌 Divisi Komputer – Himpunan Mahasiswa Elektroteknik ITB  
*Repositori utama untuk proyek, pengembangan, dan kolaborasi seputar teknologi informasi di lingkungan HME ITB.*
...
**Visi**  
Menjadi wadah utama bagi mahasiswa HME ITB untuk mengembangkan kompetensi teknologi komputer dan memberikan kontribusi nyata melalui karya digital dan solusi inovatif.
...
Repositori ini menjadi rumah bagi berbagai proyek — mulai dari:
- 🖥️ Aplikasi perangkat lunak internal
- 🌐 Web dan *frontend/backend* development
- 📡 Konfigurasi jaringan dan sistem
- 📚 Resource belajar (tutorial, modul, workshop)
